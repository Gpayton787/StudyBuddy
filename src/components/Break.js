...
function Timer(props) {
  ...
  const [timeLeft, setTimeLeft] = React.useState(10*60); // Initial time left is 25 minutes
...
//Keep track of alert
  ...
  const resetTimer = () => {
    setIsRunning(false);
    setTimeLeft(10*60); // Reset time left to 25 minutes
  };
  ...
  return (
    <div className="timer-container">
      {timeLeft === 0 && (
      <Alert variant="primary">Ready to get back on the grind?</Alert>)}
      <h1>Break time!</h1>
